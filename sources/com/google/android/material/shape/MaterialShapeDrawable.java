...
public class MaterialShapeDrawable extends Drawable implements y, Shapeable {
    ...
    class b implements ShapeAppearanceModel.CornerSizeUnaryOperator {
        ...
        public CornerSize apply(CornerSize cornerSize) {
            return cornerSize instanceof RelativeCornerSize ? cornerSize : new AdjustedCornerSize(this.f6051, cornerSize);
        }
    }
    ...
    private void drawCompatShadow(Canvas canvas) {
        ...
        for (int i5 = 0; i5 < 4; i5++) {
            this.cornerShadowOperation[i5].m7175(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
            this.edgeShadowOperation[i5].m7175(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
        }
    ...
    private void maybeDrawCompatShadow(Canvas canvas) {
        if (hasCompatShadow()) {
            ...
            float f5 = (getBounds().left - this.drawableState.shadowCompatRadius) - width;
            float f6 = (getBounds().top - this.drawableState.shadowCompatRadius) - height;
    ...
    private boolean updateTintFilter() {
        ...
        return (androidx.core.util.c.m2568(porterDuffColorFilter, this.tintFilter) && androidx.core.util.c.m2568(porterDuffColorFilter2, this.strokeTintFilter)) ? false : true;
    }
    ...
    protected int compositeElevationOverlayIfNeeded(int i5) {
    ...
    public int getShadowOffsetX() {
        double d6 = this.drawableState.shadowCompatOffset;
    ...
    public boolean requiresCompatShadow() {
        ...
        return i5 < 21 || !(isRoundRect() || this.path.isConvex() || i5 >= 29);
    }
