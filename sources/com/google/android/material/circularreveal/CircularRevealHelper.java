...
public class CircularRevealHelper {
    ...
    private void drawDebugCircle(Canvas canvas, int i5, float f5) {
        this.debugPaint.setColor(i5);
        this.debugPaint.setStrokeWidth(f5);
        CircularRevealWidget.RevealInfo revealInfo = this.revealInfo;
        canvas.drawCircle(revealInfo.centerX, revealInfo.centerY, revealInfo.radius - (f5 / 2.0f), this.debugPaint);
    }
    ...
    private boolean shouldDrawCircularReveal() {
        ...
        return STRATEGY == 0 ? !z5 && this.hasCircularRevealCache : !z5;
    }
