...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    private final androidx.vectordrawable.graphics.drawable.b hideAnimationCallback;
    ...
    private final androidx.vectordrawable.graphics.drawable.b switchIndeterminateModeCallback;
    ...
    protected BaseProgressIndicator(Context context, AttributeSet attributeSet, int i5, int i6) {
        ...
        this.minHideDelay = Math.min(obtainStyledAttributes.getInt(R.styleable.BaseProgressIndicator_minHideDelay, -1), MAX_HIDE_DELAY);
    ...
    private void registerAnimationCallbacks() {
        if (getProgressDrawable() != null && getIndeterminateDrawable() != null) {
            getIndeterminateDrawable().getAnimatorDelegate().mo7005(this.switchIndeterminateModeCallback);
        }
        if (getProgressDrawable() != null) {
    ...
    private void unregisterAnimationCallbacks() {
        if (getIndeterminateDrawable() != null) {
            ...
            getIndeterminateDrawable().getAnimatorDelegate().mo7008();
        }
        if (getProgressDrawable() != null) {
    ...
    protected void applyNewVisibility(boolean z5) {
        if (this.isParentDoneInitializing) {
            ((com.google.android.material.progressindicator.c) getCurrentDrawable()).setVisible(visibleToUser(), false, z5);
        }
    }
    ...
    protected synchronized void onMeasure(int i5, int i6) {
        ...
        setMeasuredDimension(currentDrawingDelegate.mo6990() < 0 ? View.getDefaultSize(getSuggestedMinimumWidth(), i5) : currentDrawingDelegate.mo6990() + getPaddingLeft() + getPaddingRight(), currentDrawingDelegate.mo6989() < 0 ? View.getDefaultSize(getSuggestedMinimumHeight(), i6) : currentDrawingDelegate.mo6989() + getPaddingTop() + getPaddingBottom());
    }
    ...
    public synchronized void setIndeterminate(boolean z5) {
        ...
        if ((cVar2 instanceof IndeterminateDrawable) && visibleToUser()) {
            ((IndeterminateDrawable) cVar2).getAnimatorDelegate().mo7007();
        }
        this.isIndeterminateModeChangeRequested = false;
    }
    ...
    public void setIndicatorColor(int... iArr) {
        ...
        getIndeterminateDrawable().getAnimatorDelegate().mo7004();
        invalidate();
    }
    ...
    public void setProgressCompat(int i5, boolean z5) {
        ...
        if (getProgressDrawable() != null) {
            ...
            if (!getIndeterminateDrawable().isVisible() || this.animatorDurationScaleProvider.getSystemAnimatorDurationScale(getContext().getContentResolver()) == 0.0f) {
                this.switchIndeterminateModeCallback.mo5425(getIndeterminateDrawable());
            } else {
                getIndeterminateDrawable().getAnimatorDelegate().mo7006();
            }
        }
    }
    ...
    boolean visibleToUser() {
        return f1.m2903(this) && getWindowVisibility() == 0 && isEffectivelyVisible();
    }
