...
class BaseProgressLayerDrawable<ProgressDrawableType extends IntrinsicPaddingDrawable & ShowBackgroundDrawable & TintableDrawable, BackgroundDrawableType extends IntrinsicPaddingDrawable & ShowBackgroundDrawable & TintableDrawable> extends LayerDrawable implements IntrinsicPaddingDrawable, MaterialProgressDrawable, ShowBackgroundDrawable, TintableDrawable {
    ...
    public void setShowBackground(boolean z5) {
        if (this.mBackgroundDrawable.getShowBackground() != z5) {
            this.mBackgroundDrawable.setShowBackground(z5);
            this.mSecondaryProgressDrawable.setShowBackground(!z5);
        }
    }
    ...
    public void setTint(int i5) {
        int m2279 = g0.m2279(i5, Math.round(Color.alpha(i5) * this.mBackgroundAlpha));
        this.mBackgroundDrawable.setTint(m2279);
        this.mSecondaryProgressDrawable.setTint(m2279);
        this.mProgressDrawable.setTint(i5);
    }
    ...
    public void setUseIntrinsicPadding(boolean z5) {
        this.mBackgroundDrawable.setUseIntrinsicPadding(z5);
        this.mSecondaryProgressDrawable.setUseIntrinsicPadding(z5);
        this.mProgressDrawable.setUseIntrinsicPadding(z5);
    }
}
