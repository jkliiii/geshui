...
public class IndeterminateCircularProgressDrawable extends BaseIndeterminateProgressDrawable implements MaterialProgressDrawable {
    ...
    public IndeterminateCircularProgressDrawable(Context context) {
        ...
        this.mProgressIntrinsicSize = Math.round(42.0f * f5);
        this.mPaddedIntrinsicSize = Math.round(f5 * 48.0f);
    ...
    private void drawRing(Canvas canvas, Paint paint) {
        ...
        float f5 = ringPathTransform.mTrimPathOffset;
        canvas.drawArc(RECT_PROGRESS, ((f5 + r3) * 360.0f) - 90.0f, (ringPathTransform.mTrimPathEnd - ringPathTransform.mTrimPathStart) * 360.0f, false, paint);
