...
public class Assert {
    ...
    public static void assertEquals(String message, Object expected, Object actual) {
        if (!equalsRegardingNull(expected, actual)) {
            if ((expected instanceof String) && (actual instanceof String)) {
                String cleanMessage = message == null ? BuildConfig.FLAVOR : message;
    ...
    private static boolean doubleIsDifferent(double d12, double d22, double delta) {
        return Double.compare(d12, d22) != 0 && Math.abs(d12 - d22) > delta;
    }
    ...
    private static void failNotNull(String message, Object actual) {
        String formatted = BuildConfig.FLAVOR;
        if (message != null) {
            formatted = message + " ";
        }
    ...
    public static <T> void assertThat(T actual, Matcher<? super T> matcher) {
        assertThat(BuildConfig.FLAVOR, actual, matcher);
    }
