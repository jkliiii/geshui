...
public class MaxCore {
    ...
    private Request constructLeafRequest(List<Description> leaves) {
        ...
        return new Request() { // from class: org.junit.experimental.max.MaxCore.1
            ...
            public Runner getRunner() {
                try {
                    return new Suite((Class) null, runners) { // from class: org.junit.experimental.max.MaxCore.1.1
                    };
                } catch (InitializationError e5) {
                    return new ErrorReportingRunner(null, e5);
                }
            }
        };
    }
    ...
    private Class<?> getMalformedTestClass(Description each) {
        try {
            return Class.forName(each.toString().replace(MALFORMED_JUNIT_3_TEST_CLASS_PREFIX, BuildConfig.FLAVOR));
